...
export default function CourseEnquiryForm({ course }: Props) {
    ...
    return (
      <div className="text-center py-6 space-y-4">
        ...
        <p className="text-[11px] text-slate-500 leading-relaxed max-w-[240px] mx-auto">
          Thank you! An expert study abroad advisor will reach out on WhatsApp/Email within 24 hours to begin your qualification audit.
        </p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 text-left">
      ...
      <div className="space-y-1">
        <label className="block text-[10px] font-black text-[#061331] uppercase tracking-wider">Highest Qualification</label>
        <select
          value={qualification}
      ...
      <div className="space-y-1">
        <label className="block text-[10px] font-black text-[#061331] uppercase tracking-wider">Message (Optional)</label>
        <textarea
          rows={2}
