...
export default function UniversityEnquiryForm({ university }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      fieldOfStudy: `General Inquiry - ${university.name}`,
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 text-left">
      ...
      <div className="space-y-1">
        <label className="block text-[10px] font-black text-[#061331] uppercase tracking-wider">Highest Level of Education</label>
        <select
          value={qualification}
