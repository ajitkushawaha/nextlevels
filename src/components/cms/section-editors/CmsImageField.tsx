...
export default function CmsImageField({
  ...
  return (
    <div className="space-y-2 flex items-center justify-between rounded-lg border border-slate-200 bg-white p-3">
  ...
  {mode === 'url' ? (
      ...
      {value && (
        <div className="space-y-2">
          <div
            className="h-28 rounded-md border border-slate-200 bg-slate-100 bg-cover bg-center"
